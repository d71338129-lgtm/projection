...
const changeSorter=(value:typeof sorter.value)=>{
  sorter.value=value
}
  ...
  <template>
    <div class="home-view">
      ...
      <nav class="my-nav van-hairline--bottom">
        ...
        :class="{active:sorter==='weight_desc'}" href="javascript:;">推荐</a>
        <a @click="changeSorter('undefined')"
        :class="{active:sorter==='undefined'}" href="javascript:;">最新</a>
        <div class="logo">
